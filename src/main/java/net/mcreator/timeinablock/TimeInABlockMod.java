package net.mcreator.timeinablock;
...
@Mod("time_in_a_block")
public class TimeInABlockMod {
	public static final Logger LOGGER = LogManager.getLogger(TimeInABlockMod.class);
	public static final String MODID = "time_in_a_block";

	public TimeInABlockMod() {
